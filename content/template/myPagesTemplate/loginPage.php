<div class="eduadmin loginForm">
		...
		<form action="" method="POST">
			...
			<label>
				...
				<div class="loginInput">
					<input type="email" name="eduadminloginEmail" required title="<?php echo esc_attr(edu__("Please enter your e-mail address here")); ?>" placeholder="<?php echo esc_attr(edu__("E-mail address")); ?>" />
				</div>
			</label>
			<label>
	...
	<?php unset($_SESSION['eduadmin-forgotPassSent']); } ?>

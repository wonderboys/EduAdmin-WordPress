...
function eduadmin_frontend_content()
{
	...
	wp_localize_script('eduadmin_apiclient_script', 'wp_edu', array( 'BaseUrl' => get_option('siteurl'), 'CourseFolder' => get_option('eduadmin-rewriteBaseUrl'), 'Phrases' => edu_LoadPhrases() ));
